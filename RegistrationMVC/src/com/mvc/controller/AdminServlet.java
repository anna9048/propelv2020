   ...
   public void init(){
	...
	//Add New User
			...
			private void insertUser(HttpServletRequest request,
				...
				RegisterBean newUser = new RegisterBean(fullName, email, userName, password, isActive, roleName, gender, date);
				String result = null;
			...
			private void updateUser(HttpServletRequest request,HttpServletResponse response)throws SQLException,IOException{
				...
				RegisterBean registerData = new RegisterBean(slNo, fullName, email, userName, password, isActive, roleName, gender, date);
